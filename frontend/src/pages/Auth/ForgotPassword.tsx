          ...
          {step === "form" ? (
            <>
              <div className="mb-6 sm:mb-8">
                <div
                  className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-[#5ab4e8]/10 border border-[#5ab4e8]/20
                                flex items-center justify-center mb-5"
                >
                  <svg
                    className="w-5 h-5 sm:w-6 sm:h-6 text-[#5ab4e8]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
            ...
            <div className="flex flex-col items-center text-center space-y-6 py-4">
              <div
                className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-green-500/10 border border-green-500/20
                              flex items-center justify-center"
              >
                <svg
                  className="w-7 h-7 sm:w-9 sm:h-9 text-green-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
